...
class TestSplitIntoTrainingAndTestingSets(object):
    """Test the split_into_training_and_testing_sets().
        Different test cases are: six rows, one row, one dimensional array.
    """
...
class TestTrainModel(object):
    """Test the train_model() function.
        Different test cases are: linear data, positively correlated data.
    """
...
class TestModelTest(object):
    """Test the model_test() function.
        Different test cases are: perfect fit, circular data, one dimensional array.
    """
